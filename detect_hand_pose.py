...
def worker(input_q, output_q, cropped_output_q, inferences_q, cap_params, frame_processed):
    ...
    try:
        model, classification_graph, session = classifier.load_KerasGraph("cnn/models/hand_detector_15_Epoch.h5")
...
if __name__ == '__main__':
    ...
    cv2.namedWindow('Hand pose recognition', cv2.WINDOW_NORMAL)
